import { ConfigConsumer, ConfigProvider, ConfigProviderWrap } from '@ant-design/pro-provider';
...
export { ConfigProviderWrap, Search, ConfigProvider, ConfigConsumer, ProTable };
